    ...
    <div className="*:data-[slot=card]:shadow-xs @xl/main:grid-cols-2 @5xl/main:grid-cols-4 grid grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card lg:px-6">
      <Card className="@container/card">
        <CardHeader className="relative">
          ...
          <div className="absolute right-4">
            <Badge variant="outline" className="flex gap-1 rounded-lg font-bold text-xs">
      ...
      <Card className="@container/card">
        <CardHeader className="relative">
          ...
          <div className="absolute right-4">
            <Badge variant="outline" className="flex gap-1 font-bold rounded-lg text-xs">
      ...
      <Card className="@container/card">
        <CardHeader className="relative">
          ...
          <div className="absolute right-4">
            <Badge variant="outline" className="flex font-bold gap-1 rounded-lg text-xs">
              <TrendingUpIcon className="size-3" />
              +4.5%
            </Badge>
          </div>
